...
template <Gnl> class FMBiGainCalc {
  ...
  public:
     ...
     * @param[in] hyprgraph
     */
    pub fn new(hyprgraph: &Gnl, u8 /*num_parts*/) { FMBiGainCalc
        : hyprgraph{hyprgraph}, vertex_list(hyprgraph.number_of_modules()), rsrc(stack_buf, sizeof stack_buf), idx_vec(&rsrc) {
